    ...
    <div className="App">
      ...
      <div className="content2">
        ...
        <div className="aboutme-content">
          ...
          I'm currently learning Unity and actively building that game. Alongside that, I have a background in web development and have built projects like an eCommerce site from scratch. I'm driven by a simple goal: to create something that sticks with people the way games have always stuck with me.
        </div>
